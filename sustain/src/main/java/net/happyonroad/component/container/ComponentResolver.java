...
public interface ComponentResolver {
     ...
     * @param dependency 引入该组件的依赖信息，主要是其中可能带有部分排除信息
     * @param resource jar 或者 pom文件的路径，该文件名称必须有正确的格式化，具体来讲，就是应该遵循：
     ...
     */
    Component resolveComponent(Dependency dependency, Resource resource) throws InvalidComponentException, InvalidComponentNameException, DependencyNotMeetException;
}
